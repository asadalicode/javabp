        ...
        <>
            ...
            <BackroundImage url={IsMobile() ? TopMobileBg : TopBg} classes='bg-contain'>
                <div className="bg-center-text text-center space-y-6">
                    ...
                    <button onClick={() => navigateByUrl('/businessTemplate')} className="rounded bg-yellow-secondary w-auto px-4 h-12 hover:bg-yellow ">
            ...
            <BackroundImage url={Section1Bg} classes="text-center space-y-9  bg-right">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-1 gap-10 px-16 sm:px-8">
                    <div className="p-6 space-y-4 bg-white  rounded-2xl card-shadow ">
                        ...
                        <h5 onClick={() => navigateByUrl('/company')} className="mb-2 hover:text-yellow hover:underline font-bold tracking-tight text-black text-left max-w-xs cursor-pointer">Company Formations (Local and Offshore)</h5>
                    ...
                    <div className=" p-6 space-y-4 bg-white rounded-2xl card-shadow ">
                        ...
                        <h5 onClick={() => navigateByUrl('/company')} className="mb-2 hover:text-yellow hover:underline font-bold tracking-tight text-black text-left max-w-xs cursor-pointer">Remote Company Bank Account Opening</h5>
                    ...
                    <div className=" p-6 space-y-4 bg-white rounded-2xl  card-shadow ">
                        ...
                        <h5 onClick={() => navigateByUrl('/citizenship')} className="mb-2 hover:text-yellow hover:underline font-bold tracking-tight text-black text-left max-w-xs cursor-pointer">Citizenship And Residency By Investment</h5>
                    ...
                    <div className=" p-6 space-y-4 bg-white rounded-2xl  card-shadow ">
                        ...
                        <h5 onClick={() => navigateByUrl('/citizenship')} className="mb-2 hover:text-yellow hover:underline font-bold tracking-tight text-black text-left max-w-xs cursor-pointer">Golden Visa And 2nd Passport Programs Applications</h5>
                    ...
                    <div className=" p-6 space-y-4 bg-white rounded-2xl  card-shadow ">
                        ...
                        <h5 onClick={() => navigateByUrl('/business')} className="mb-2 hover:text-yellow hover:underline font-bold tracking-tight text-black text-left max-w-xs cursor-pointer">Business, Financial, And Legal Documents And Templates</h5>
                    ...
                    <div className=" p-6 space-y-4 bg-white rounded-2xl  card-shadow ">
                        ...
                        <h5 onClick={() => navigateByUrl('/capitalInvestment')} className="mb-2 hover:text-yellow hover:underline font-bold tracking-tight text-black text-left max-w-xs cursor-pointer">Private Investment And Business Funding Options</h5>
            ...
            <section className="grid grid-cols-2 mt-16  sm:grid-cols-1 bg-white">
                <BackroundImage url={IsMobile() ? Section2MobBg : ''} classes={`text-center bg-left`}>
                    <img className="max-w-xl w-4/5 sm:w-full " alt="" src={Section2UpperBg} />
                </BackroundImage>
            ...
            <section className="grid grid-cols-2 gap-8 pb-6  sm:grid-cols-1  sm:px-8">
                ...
                <BackroundImage url={IsMobile() ? '' : ''} classes={`text-center bg-right !h-full sm:hidden`}>
                    <img className="h-full w-full object-cover" alt="" src={Section3Bg} />
                </BackroundImage>
            </section>
            ...
            <BackroundImage url={Section4Bg} className="bg-cover">
                ...
                <section className="flex justify-between sm:flex-col   sm:px-8  sm:grid-cols-1 bg-black ">
                    ...
                    <img className="sm:hidden hover:opacity-50" alt="" src={Section4UpperBg} />
